...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#activity-list").on("click", "input[name='activity-select']", function () {
                var flag = $("input[name='activity-select']").length === $("input[name='activity-select']:checked").length;
            ...
            //创建市场活动关联按钮事件
            $("#create-relationBtn").on("click", function () {
                createRelation();
            });
            //市场活动查询
        ...
        function getRemarkList() {
            $.ajax({
                url: "workbench/contacts/getRemarkList.do",
                data: {
                ...
                success: function (data) {
                    var contactsName = "${contacts.fullName}${contacts.appellation}-${contacts.customerId}"
                    var htmlStr = "";
                    $.each(data, function (i, remark) {
                        ...
                        htmlStr += "<span style='color: gray; '>联系人</span> <span style='color: gray; '>-</span> <b>" + contactsName + "</b> <small style='color: gray;'> " + (remark.editFlag ? remark.editTime : remark.createTime) + " 由 " + remark.createBy + "</small>";
        ...
        function editRemark(id) {
            $.ajax({
                url: "workbench/contacts/getRemarkContent.do",
                data: {
                    "id": id
                },
                dataType: "json",
        ...
        function getTranList() {
            $.ajax({
                url: "workbench/contacts/getTranList.do",
                data: {
                    "contactsId": $("#contactsId").val()
                },
                type: "get",
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, tran) {
                        htmlStr += "<tr>";
                        htmlStr += "<td><a href='workbench/tran/detail.do?id=" + tran.id + "' style='text-decoration: none;'>动力节点-交易01</a></td>";
                        htmlStr += "<td>" + tran.money + "</td>";
                        htmlStr += "<td>" + tran.stage + "</td>";
                        htmlStr += "<td>" + json[tran.stage] + "</td>";
                        htmlStr += "<td>" + tran.expectedDate + "</td>";
                        htmlStr += "<td>" + tran.type + "</td>";
                        htmlStr += "<td><a href='javascript:void(0)' onclick='deleteTran('" + tran.id + "')'";
                        htmlStr += "style='text-decoration: none;'><span class='glyphicon glyphicon-remove'></span>删除</a></td>";
                        htmlStr += "</tr>";

                    });
                    $("#tran-list").html(htmlStr);
                }
            });
        }
        ...
        function getRelationList() {
            $.ajax({
                url: "workbench/contacts/getRelationList.do",
                data: {
                    "contactsId": $("#contactsId").val()
                },
                type: "get",
        ...
        function getActivityList() {
            $.ajax({
                url: "workbench/contacts/getActivityList.do",
                data: {
                    "contactsId": $("#contactsId").val(),
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        htmlStr += "<tr>";
                        htmlStr += "<td><input type='checkbox' name='activity-select' value='" + n.id + "'/></td>";
                        htmlStr += "<td>" + n.name + "</td>";
                        htmlStr += "<td>" + n.startDate + "</td>";
                        htmlStr += "<td>" + n.endDate + "</td>";
                        htmlStr += "<td>" + n.owner + "</td>";
        ...
        function createRelation() {
            ...
            if (obj.length > 0) {
                ...
                param += "contactsId=" + $("#contactsId").val();
                $.ajax({
                    url: "workbench/contacts/createRelation.do",
                    data: param,
                    type: "get",
                    dataType: "json",
                    success: function (data) {
...
<div class="modal fade" id="bundActivityModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" id="create-relationBtn">关联</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div id="remark-list">
        ...
        <div class="remarkDiv" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <span style="color: gray; ">联系人</span> <span
                    style="color: gray; ">-</span> <b>李四先生-北京动力节点</b> <small style="color: gray;"> 2017-01-22 10:10:10
                由zhangsan</small>
        ...
        <div class="remarkDiv" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                <h5>呵呵！</h5>
                <span style="color: gray; ">联系人</span> <span
                    style="color: gray; ">-</span> <b>李四先生-北京动力节点</b> <small style="color: gray;"> 2017-01-22 10:20:10
                由zhangsan</small>
                <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                    <a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit"
                                                                       style="font-size: 20px; color: #E6E6E6;"></span></a>
    ...
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a href="javascript:void(0);" data-toggle="modal" data-target="#bundActivityModal"
               style="text-decoration: none;" id="open-search"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
        </div>
    </div>
</div>
