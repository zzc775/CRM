    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#selectAllBtn").on("click", function () {
                $("input[name='customer-select']").prop("checked", this.checked);
            })

            $("#customerList").on("click", "input[name='customer-select']", function () {
                var flag = $("input[name='customer-select']:checked").length === $("input[name='customer-select']").length;
        ...
        function getCustomerList() {
            $.ajax({
                url: "workbench/customer/getList.do",
                type: "get",
                dataType: "json",
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        htmlStr += "<tr>";
                        htmlStr += "<td><input type='checkbox' value='"+n.id+"' name='customer-select'/></td>";
                        htmlStr += "<td><a style='text-decoration: none; cursor: pointer;'";
                        htmlStr += "href='workbench/customer/detail.do?id=" + n.id + "'>"+n.name+"</a></td>";
                        htmlStr += "<td>"+n.owner+"</td>";
                        htmlStr += "<td>"+n.phone+"</td>";
                        htmlStr += "<td>"+n.website+"</td>";
                        htmlStr += "</tr>";
                    });
        ...
        <div style="position: relative;top: 10px;">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>zhangsan</td>
                    <td>010-84846003</td>
                    <td>https://www.bjpowernode.com</td>
                </tr>
                <tr class="active">
                    <td><input type="checkbox"/></td>
